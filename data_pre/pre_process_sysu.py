...
np.save(data_path + 'train_rgb_resized_img256_192.npy', train_img)
np.save(data_path + 'train_rgb_resized_label256_192.npy', train_label)

# ir imges
train_img, train_label = read_imgs(files_ir)
np.save(data_path + 'train_ir_resized_img256_192.npy', train_img)
np.save(data_path + 'train_ir_resized_label256_192.npy', train_label)
