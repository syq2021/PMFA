...
parser.add_argument('--data_path', default='data/SYSU/', type=str, help='./test_data')
...
gall_img, gall_label, gall_cam = process_gallery_sysu_m(data_path, mode=args.mode, trial=0)
...
for j in range(30000):
    if j % 10 == 0:
        print(j)
        result = scipy.io.loadmat('tsne_base_m.mat')
        ...
        fig.savefig("./save_ranking_base/show" + str(j) + ".jpg")