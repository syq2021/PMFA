...
class Bottleneck_IBN(nn.Module):
    ...
    def __init__(self, inplanes, planes, ibn=None, stride=1, downsample=None, dilation=1):
...
class ResNet_IBN(nn.Module):
    ...
    def __init__(self,
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], stride=last_conv_stride, dilation=last_conv_dilation, ibn=ibn_cfg[3])
...
def resnet50_ibn_a(pretrained=False, **kwargs):
    ...
    model = ResNet_IBN(block=Bottleneck_IBN,
                       ...
                       **kwargs)
    if pretrained:
        model.load_state_dict(remove_fc(torch.hub.load_state_dict_from_url(model_urls['resnet50_ibn_a'])))
    return model
...
def resnet50_ibn_b(pretrained=False, **kwargs):
    ...
    model = ResNet_IBN(block=Bottleneck_IBN,
                       ...
                       **kwargs)
    if pretrained:
        model.load_state_dict(remove_fc(torch.hub.load_state_dict_from_url(model_urls['resnet50_ibn_b'])))
    return model
